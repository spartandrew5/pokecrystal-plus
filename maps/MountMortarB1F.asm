...
MountMortarB1F_MapEvents:
	...
	def_object_events
	object_event 29, 12, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MountMortarB1FMagmarizer, EVENT_MOUNT_MORTAR_B1F_HYPER_POTION
